...
const randomImage =
  "https://source.unsplash.com/1600x900/?natura,photography,technology";
            ...
            <div className="flex justify-center font-bold w-full text-xl mt-2">
              {activeBtn === "created" ? (
                <div className="flex flex-col justify-center items-center gap-5">
                  No Pins Found!
                  <button
                    className="bg-black text-white font-bold text-xl p-2 rounded-full outline-none flex justify-center items-center"
                    onClick={() => {
                      navigate("/create-pin");
                    }}
                  >
